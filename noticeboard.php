...
if (isset($_GET['delid'])) {
    ...
    $query_delete_timetable = mysqli_prepare($con, "DELETE FROM notice_board WHERE Notice_id=?");
    ...
    if (!$result_delete_timetable) {
        echo "Error deleting record from noticeboard: " . mysqli_error($con);
    }
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="title">
                                    <h2>Notice Board <b>Management</b></h2>
                                </div>
                                <div class="addbutton" align="right">
                                    <a href="addnotice.php" class="add-user-btn">Add New Notice</a>
                                </div>
                            </div>
                        </div>
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="editnotice.php?editid=<?php echo htmlentities($row['Notice_id']); ?>"
                                                    class="action-icons edit" title="Edit" data-toggle="tooltip"><i class='fas fa-edit'></i></a>
                                                <a href="noticeboard.php?delid=<?php echo htmlentities($row['Notice_id']); ?>"
