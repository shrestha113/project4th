                ...
                if (mysqli_num_rows($result) > 0) {
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="read.php?viewid=<?php echo htmlentities($row['ID']); ?>" class="action-icons view"
                          title="View" data-toggle="tooltip">View</a>
                        <a href="edit.php?editid=<?php echo htmlentities($row['ID']); ?>" class="action-icons edit"
                          title="Edit" data-toggle="tooltip">Edit</a>
                        <a href="index.php?delid=<?php echo htmlentities($row['ID']); ?>" class="action-icons delete"
